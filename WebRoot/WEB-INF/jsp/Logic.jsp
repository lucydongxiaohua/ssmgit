      ...
      <ul class="sidebar-menu">
       ...
       <!--  <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="Logic.jsp"><i class="fa fa-bookmark"></i> numberone</a></li>
...
<div class="content-wrapper">
  ...
  <embed   id="viewArea" src="assets/images/gallery/5.svg"  xmlns="http://www.w3.org/2000/svg"  hight="900"  width="1300"    preserveAspectRatio="xMidYMid meet" type="image/svg+xml" pluginspage="http://www.adobe.com/svg/viewer/install/"  
 ...
 /*   if (goCenter == true){
  ...
  if (goUp == true){
     if (currentPosition1 < 1300) {
          currentPosition1 = currentPosition1 + 200;
     }
     goUp = false;
  ...
  if (goIn == true){
          ...
          currentPosition2 = currentPosition2 /0.5;
           currentPosition3 = currentPosition3 /0.5 ;
      goIn = false;
