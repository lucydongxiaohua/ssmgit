...
<div class="videozz"></div>
  ...
  <%-- <b class="model" style='position:absolute; left:880px;position:absolute;  top:180px  ;background : #e94b19; border: 2px solid #ccc; font-family:  华文行楷 ; display: inline;' >    ${msg }</br></b> --%>
<div class="box">
	<div class="box-a">
    <div class="m-2">
          <div class="m-2-1">
       ...
       <!--  <input   type="text" value="去注册" style='font-size:20px;background : #D9D919; border: 1px solid #ccc; font-family:  华文行楷 ;'    />-->
            
           <a style='font-size:50px;background : #D9D919; border: 2px solid #ccc; font-family:  华文行楷 ;' href="${pageContext.request.contextPath }/regist.jsp">去注册</a>  
           
            <%--   ${msg }</br>   --%>
          <!--  <input   type="button" value="去注册" style='font-size:20px;background : #D9D919; border: 1px solid #ccc; font-family:  华文行楷 ;'  -->
          
          <a style='font-size:50px;background : #D9D919; border: 2px solid #ccc; font-family:  华文行楷 ; margin-top:40px;' href="${pageContext.request.contextPath }/login.jsp">重新登陆</a>  
